...
while ($row = mysql_fetch_assoc($res)) {
		...
		echo "<tr>
			...
			<td>
				<a data-toggle='modal' title='Delete' onclick=\"return confirm('Are you want to delete?')\" href='lib/removeParticipant.php?id=".$id."&participant=".$row['person_id']."&role=3' type='button' class='btn btn-danger btn-xs' aria-label='Left Align'>
